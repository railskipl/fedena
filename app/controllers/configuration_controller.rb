class ConfigurationController < ApplicationController
  ...
  FILE_EXTENSIONS = [".jpg",".jpeg",".png",".doc",".pdf",".txt"]#,".gif",".png"]
  ...
  def settings
    @config = Configuration.get_multiple_configs_as_hash ['InstitutionName', 'InstitutionAddress', 'InstitutionPhoneNo', \
        'StudentAttendanceType', 'CurrencyType', 'ExamResultType','HomeworkResultType', 'AdmissionNumberAutoIncrement','EmployeeNumberAutoIncrement']
